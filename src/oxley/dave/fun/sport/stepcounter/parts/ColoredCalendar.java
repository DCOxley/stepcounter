...
public class ColoredCalendar  implements MouseListener {
    ...
    public ColoredCalendar(Composite parent, int style) {
    }

    public ColoredCalendar(Composite parent) {
        this(parent, 0);
    }
...
days[i].setBackground(display.getSystemColor(SWT.COLOR_BLUE)); //
    ...
    public Object open(Composite parent) {
        shell = new Shell(parent.getDisplay(),  SWT.TITLE |SWT.PRIMARY_MODAL);
