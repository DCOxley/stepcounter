 ...
 * @generated
 */
public class StepcounterSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StepcounterPackage.TARGET: {
			...
			case StepcounterPackage.STATUS: {
				Status status = (Status)theEObject;
				T result = caseStatus(status);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepcounterPackage.PUNISHMENT: {
				Punishment punishment = (Punishment)theEObject;
				T result = casePunishment(punishment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepcounterPackage.REWARD: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sport Target</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sport Target</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSportTarget(SportTarget object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Punishment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Punishment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePunishment(Punishment object) {
		return null;
	}
